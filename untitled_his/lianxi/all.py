...
class TestHis(unittest.TestCase):
    ...
    def test002(self):
        time.sleep(2)
        browser.find_element_by_xpath("/html/body/div[2]/aside/section/ul/li[2]/a/i").click()#点击预约挂号
        time.sleep(5)
    ...
    def test007(self):
        ...
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="addMadicine"]').send_keys(u"阿")  # 在处方药品处输入阿
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="addMadiclRelateList"]/p[1]/span[1]').click()  # 选择阿奇霉素注射用
        time.sleep(2)
    ...
    def test010(self):  # 检验工作台
        time.sleep(2)
        browser.find_element_by_xpath('/html/body/div[2]/aside/section/ul/li[4]/a').click()  # 点击检验工作台
        time.sleep(1)
    ...
    def test011(self):
        browser.find_element_by_xpath('/html/body/div[2]/aside/section/ul/li[6]/a').click()#点击治疗
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="checkout_patient_cart_content"]/div[1]/div[2]/a').click()#点击开始治疗
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="ajax-content"]/div[1]/div/div[2]/div[2]/div[3]/table/tbody/tr[1]/td[8]/span').click()#点击执行
        time.sleep(3)
    ...
    def test012(self):  # 检查工作台
        time.sleep(2)
        browser.find_element_by_xpath('/html/body/div[2]/aside/section/ul/li[5]/a').click()  # 点击检查工作台
        time.sleep(1)
    ...
    def test013(self):  # 点击收费/发药
        browser.find_element_by_xpath('/html/body/div[2]/aside/section/ul/li[8]/a/span[1]').click()# 点击收费/发药
        time.sleep(2)
    ...
    def test014(self):#点击结算管理
        ...
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="table_excel"]/tbody/tr[1]/td[13]/a').click()#点击详情
        time.sleep(2)
    ...
    def test_SignIn(self):
        ...
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="appointRegister_patientCart_content"]/div/div[2]/a').click()  # 点击改约
        time.sleep(2)
        ...
        time.sleep(2)
        browser.find_element_by_xpath(
            '//*[@id="appointRegister_patientCart_content"]/div/div[2]/p[1]').click()  # 点击签到
        time.sleep(5)
        browser.find_element_by_xpath('/html/body/div[2]/aside/section/ul/li[3]/a/span[1]').click()  # 点击医生工作台
        time.sleep(5)
        browser.find_element_by_xpath(
            '//*[@id="doctor_patient_cart_content"]/div[1]/div[2]/span[1]').click()  # 点击接诊
    ...
    def test_Storage(self):
        ...
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr/td[10]/input[2]').clear()
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr/td[10]/input[2]').send_keys(10)
        time.sleep(1)
        ...
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr[2]/td[10]/input[2]').clear()
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr[2]/td[10]/input[2]').send_keys(10)
        time.sleep(1)
        ...
        time.sleep(1)
        browser.find_element_by_xpath(
            '//*[@id="ajax-content"]/div/div/form/div/ul/li/ul/li/div[3]/input').send_keys(u"同仁堂")
        time.sleep(1)
        ...
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr[3]/td[10]/input[4]').clear()
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr[3]/td[10]/input[4]').send_keys(10)
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="choosekey"]').send_keys(u"达克宁")
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="choose"]/tbody/tr[2]').click()
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr[4]/td[6]/input').send_keys(1111)
        time.sleep(1)
        ...
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr[4]/td[10]/input[4]').clear()
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr[4]/td[10]/input[4]').send_keys(10)
        time.sleep(1)
        ...
        browser.find_element_by_xpath('//*[@id="choosekey"]').send_keys(u"达克宁")
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="choose"]/tbody/tr[3]/td[3]').click()
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr/td[11]/input[4]').clear()
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr/td[11]/input[4]').send_keys(8)
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="choosekey"]').send_keys(u"三伏贴")
        time.sleep(2)
        ...
        time.sleep(2)
        #点击领用人
        browser.find_element_by_xpath('//*[@id="ajax-content"]/div/div/form/div/ul/li/ul/li/div[4]/span/span[1]/span/span[2]').click()
        time.sleep(2)
        ...
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr[3]/td[11]/span').click()  #删除一次性自粘敷贴
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="ajax-content"]/div/div/form/div/ul/li/ul/li/div[3]/input').send_keys(u"鲁抗制药")  #
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="stockIn_edit_save"]').click()  #点击提交审核
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="StockBills_menu0"]/span[1]').click()  #点击详情
        ...
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr[4]/td[11]/span').click()  #
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="stockIn_edit_save"]').click()  #点击保存
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="StockBills_menu0"]/span[4]').click()  #点击审核
        ...
        browser.find_element_by_xpath('//*[@id="choose"]/tbody/tr[1]/td[3]').click()  #
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="stockIn_edit"]/tbody/tr[3]/td[12]/span')  # 点击删除
        time.sleep(2)
        browser.find_element_by_xpath('//*[@id="ajax-content"]/div/div/form/div/ul/li/ul/li/div[3]/span/span[1]/span/span[2]').click()  #选择领用科室
        time.sleep(1)
        browser.find_element_by_xpath('/html/body/span/span/span[1]/input').send_keys(u"中医全科")  #
        time.sleep(1)
        browser.find_element_by_xpath('/html/body/span/span/span[1]/input').send_keys(Keys.ENTER)  #
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="ajax-content"]/div/div/form/div/ul/li/ul/li/div[4]/span/span[1]/span/span[2]').click()  #点击领用人
        time.sleep(1)
        ...
        browser.find_element_by_xpath('//*[@id="choosekey"]').send_keys(u"碘伏棉签") #
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="choose"]/tbody/tr[1]/td[5]').click()  #
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="stockIn_edit_save"]').click()  #点击保存
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="StockBills_menu0"]/span[4]').click()  #点击审核
